...
<html>
<head>
    <title>Men&uacute; principal | BancApp</title>
                ...
                <div class="row mb-3">
                    <form:form action="/chats/solicitudAsistencia" method="post">
                        <div class="col">
                            ...
                            <input type="submit" href="/chats/solicitudAsistencia"
                                   class="btn btn-lg btn-outline-secondary" value="Busca chat con un asistente">
                        </div>
                    </form:form>
                    <br/>
                    <form:form action="/chats/" method="get">
                        <div class="col">
                            <input type="hidden" id="cliente" name="cliente"
                                   value="<%=usuario.getClienteByCliente().getIdCliente()%>">
                            <input type="submit" class="btn btn-lg btn-outline-secondary"
                                   value="Acceder a los chats con asistentes">
                        </div>
                    </form:form>
